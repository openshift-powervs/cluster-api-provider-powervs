...
// Ptr2String returns a pointer to the string value passed in.
...
//	return []*string{
//		Ptr2String(awsclient.InstanceStateNameRunning),
//		Ptr2String(awsclient.InstanceStateNamePending),
//		Ptr2String(awsclient.InstanceStateNameStopped),
//		Ptr2String(awsclient.InstanceStateNameStopping),
//		Ptr2String(awsclient.InstanceStateNameShuttingDown),
//	}
//}
