...
//func (c *awsClient) CreateInstance(params *p_cloud_p_vm_instances.PcloudPvminstancesPostParams) (*models.PVMInstanceList, error) {
//	panic("implement me")
//}
//
//func (c *awsClient) GetInstance(id string) (*models.PVMInstance, error) {
//	panic("implement me")
//}
//
//func (c *awsClient) GetInstanceByName(name string) (*models.PVMInstance, error) {
//	panic("implement me")
//}
//
//func (c *awsClient) GetInstances() (*models.PVMInstances, error) {
//	panic("implement me")
//}
//
//func (c *awsClient) DeleteInstance(id string) error {
//	panic("implement me")
//}
//
...
//	//case len(secret.Data["IBMCLOUD_API_KEY"]) > 0 && len(secret.Data["aws_secret_access_key"]) > 0:
